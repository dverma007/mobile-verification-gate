...
__export(index_exports, {
  DEFAULT_MOBILE_VERIFICATION_GATE_STORAGE_KEY: () => DEFAULT_MOBILE_VERIFICATION_GATE_STORAGE_KEY,
  MOBILE_VERIFICATION_GATE_COPY: () => MOBILE_VERIFICATION_GATE_COPY,
  MobileVerificationGate: () => MobileVerificationGate,
  buildMobileVerificationGateCopy: () => buildMobileVerificationGateCopy,
  clearMobileVerificationGateMarker: () => clearMobileVerificationGateMarker,
  default: () => index_default,
  markMobileVerificationGateForEmailLogin: () => markMobileVerificationGateForEmailLogin,
  readMobileVerificationGateMarker: () => readMobileVerificationGateMarker,
  shouldOpenMobileVerificationGate: () => shouldOpenMobileVerificationGate
});
...
function MobileVerificationGate({
  ...
  var _a;
  const resolvedCopy = (0, import_react.useMemo)(
  ...
  const [step, setStep] = (0, import_react.useState)("collect");
  const [mobile, setMobile] = (0, import_react.useState)("");
  const [formattedMobile, setFormattedMobile] = (0, import_react.useState)("");
  const [otp, setOtp] = (0, import_react.useState)("");
  const [errorMessage, setErrorMessage] = (0, import_react.useState)("");
  const [isSubmitting, setIsSubmitting] = (0, import_react.useState)(false);
  const normalizedMobile = (0, import_react.useMemo)(
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: "mobile-verification-gate-title", style: { margin: 0, fontSize: "1.25rem" }, children: resolvedCopy.title }),
